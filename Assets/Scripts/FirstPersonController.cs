...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (CrossPlatformInputManager.GetButtonDown ("Fire1") && timer >= 2.0) { //added
                gameObject.GetComponent<CharacterController>().Move(m_Camera.transform.forward * -500 * Time.deltaTime); //added
                timer = 0;
            } //added
